 ...
 *         &lt;element name="Notification" type="{http://soap.sforce.com/2005/09/outbound}Test_Automation__cNotification" maxOccurs="100"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Notifications {
    ...
    protected List<TestAutomationCNotification> notification;
     ...
     * {@link TestAutomationCNotification }
     * 
     * 
     */
    public List<TestAutomationCNotification> getNotification() {
        if (notification == null) {
            notification = new ArrayList<TestAutomationCNotification>();
        }
